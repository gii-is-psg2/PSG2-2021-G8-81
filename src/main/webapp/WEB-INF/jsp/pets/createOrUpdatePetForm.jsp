        ...
        <form:form modelAttribute="pet"
            ...
            <div class="form-group has-feedback">
                <div class="form-group">
                    <label class="col-sm-2 control-label"><fmt:message key="ow"/></label>
                    <div class="col-sm-10">
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    <c:choose>
                        <c:when test="${pet['new']}">
                            <button class="btn btn-default" type="submit"><fmt:message key="apet"/></button>
                        </c:when>
                        <c:otherwise>
                            <button class="btn btn-default" type="submit"><fmt:message key="upet"/></button>
                        </c:otherwise>
                    </c:choose>
                </div>
            </div>
